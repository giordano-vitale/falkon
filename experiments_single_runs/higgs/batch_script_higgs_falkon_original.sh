...
#SBATCH --job-name=higgs_test_falkon_original
#SBATCH --partition=boost_usr_prod                      # The Booster partition name
#SBATCH --qos=normal                                    # Quality of service
#SBATCH --time=2:00:00                                  # Walltime
#SBATCH --output=higgs_test_falkon_original_print.log   # Output file
#SBATCH --error=higgs_test_falkon_original_err.log      # Error file
...
#SBATCH --cpus-per-gpu=8                    # All 32 CPUs
...
python3 falkon_original_test_higgs.py
