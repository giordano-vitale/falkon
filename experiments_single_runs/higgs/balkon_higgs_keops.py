...
options = falkon.options.FalkonOptions(keops_active=keops_active, m0=m0, test_partial_iterations=test_partial_iterations, memory_slack=memory_slack, debug=debug)
