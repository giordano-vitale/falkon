...
#SBATCH --job-name=higgs_test_keopsfp32
...
#SBATCH --output=higgs_test_keopsfp32_print.log     # Output file
#SBATCH --error=higgs_test_keopsfp32_err.log        # Error file
...
python3 balkon_test_higgs_keopsfp32.py
