...
#SBATCH --job-name=msd_test_left_prec
#SBATCH --partition=boost_usr_prod                  # The Booster partition name
#SBATCH --qos=normal                                # Quality of service
#SBATCH --time=2:00:00                              # Walltime
#SBATCH --output=msd_test_left_prec_print.log       # Output file
#SBATCH --error=msd_test_left_prec_err.log          # Error file
