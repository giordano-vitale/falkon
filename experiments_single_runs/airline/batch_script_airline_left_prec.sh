...
#SBATCH --job-name=airline_test_left_prec
#SBATCH --partition=boost_usr_prod                  # The Booster partition name
#SBATCH --qos=normal                                # Quality of service
#SBATCH --time=6:00:00                              # Walltime
#SBATCH --output=airline_test_left_prec_print.log   # Output file
#SBATCH --error=airline_test_left_prec_err.log      # Error file
...
python3 balkon_test_airline.py
