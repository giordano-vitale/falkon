...
#SBATCH --job-name=airline_test_falkon_original
#SBATCH --partition=boost_usr_prod                      # The Booster partition name
#SBATCH --qos=normal                                    # Quality of service
#SBATCH --time=2:00:00                                  # Walltime
#SBATCH --output=airline_test_falkon_original_print.log # Output file
#SBATCH --error=airline_test_falkon_original_err.log    # Error file
...
python3 falkon_original_test_airline.py
